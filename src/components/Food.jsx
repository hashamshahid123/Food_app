    ...
    <div className='max-w-[1640px] m-auto px-4 py-12'>
        ...
        <div className='flex flex-col lg:flex-row justify-between'>
            ...
            <div>
                ...
                <div className='flex justify-between max-w[300px] x-full'>
                    <button
                    ...
                    onClick={() => filterPrice('$150')}
                     className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>$150</button>
                    <button
                    onClick={() => filterPrice('$200')}
                     className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>$200</button>
                </div>
            </div>
        </div>
